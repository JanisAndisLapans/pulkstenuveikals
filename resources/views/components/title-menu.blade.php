...
>
    <div class="col-md-5 p-lg-3 mx-auto my-4 ">
        <h1 class="display-4 font-weight-normal text-primary">Pulksteņu veikals</h1>
        <p class="lead font-weight-normal text-warning">Tikai paši labākie pulksteņi no uzticamākajiem ražotājiem.</p>
    </div>
